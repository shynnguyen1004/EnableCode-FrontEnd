...
const vi = {
  ...
  calibration: {
    ...
    holdTop: 'Hướng đầu về giữa cạnh trên màn hình',
    holdRight: 'Hướng đầu về giữa cạnh phải màn hình',
    holdBottom: 'Hướng đầu về giữa cạnh dưới màn hình',
    holdLeft: 'Hướng đầu về giữa cạnh trái màn hình',
    captured: 'Đã ghi nhận!',
    completeTitle: 'Thiết lập hoàn tất!',
    completeBody: 'Hồ sơ điều khiển khuôn mặt của bạn đã được lưu. Xoay đầu nhẹ để di chuyển và há miệng để click.',
